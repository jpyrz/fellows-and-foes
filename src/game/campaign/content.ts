...
const companionBase = [
  {
    ...
    armorType: 'heavy' as const,
    secondaryClassId: 'none' as const,
  ...
  },
  {
    ...
    classId: 'arcanist' as const,
    armorType: 'robe' as const,
    secondaryClassId: 'none' as const,
    ...
    'flooded-gaol': {
      ...
      actions: [
        ...
        },
        {
          ...
          successEffects: [
            { type: 'set-flag', flag: 'bloodied-escape' },
